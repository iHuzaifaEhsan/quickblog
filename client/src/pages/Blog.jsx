  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary cursor-pointer'>Huzaifa Ehsan</p>
      </div>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='max-w-3xl mx-auto'>
          ...
          <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
            ...
            <button type='submit' placeholder='Comment' className='bg-primary text-white rounded p-2 px-8 hover:scale-102 transition-all cursor-pointer'>Submit</button>
